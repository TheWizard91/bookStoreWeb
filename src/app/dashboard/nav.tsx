    ...
    return (
        <div className="container-fluid" style={{margin:"8px"}}>
            <div className="row">
                ...
                <div className="col">
                    <nav class="navbar navbar" style={{marginLeft: "auto", listStyleType: "none", justifyContent:"end"}}>
                        <ul style={{listStyleType: "none", display: "flex"}}>
                            <li className="nav-item">
                                <a className="nav-link" href="/shop">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="black" class="bi bi-cart" viewBox="0 0 16 16">
